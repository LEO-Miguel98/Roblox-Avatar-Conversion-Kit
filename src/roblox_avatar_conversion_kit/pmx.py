...
def _mmd_uv(value): return (value[0], 1.0 - value[1])
...
def write_pmx(
    ...
    *,
    ...
    for face in mesh.faces:
        ...
        for vertex_index, uv_index, normal_index in face.corners:
            ...
            if key not in vertex_map:
                ...
                uv = _mmd_uv(mesh.uvs[uv_index]) if uv_index is not None and 0 <= uv_index < len(mesh.uvs) else (0.0, 0.0)
    ...
    comment = "Generated by Roblox Avatar Conversion Kit v0.3.6. Skin weights and accessory physics are reconstructed and approximate."
